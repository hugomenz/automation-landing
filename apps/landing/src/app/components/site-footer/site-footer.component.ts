  ...
  readonly copy = computed(() =>
    this.language() === 'de'
      ? {
          ...
          industriesLabel: 'Beispiele für Maschinenfamilien',
          endOfLineLink: 'End-of-Line-Anlagen',
          packagingLink: 'Verpackungsmaschinen',
          palletisingLink: 'Palettieranlagen',
      ...
      : {
          ...
          industriesLabel: 'Machine-family examples',
          endOfLineLink: 'End-of-line equipment (DE)',
          packagingLink: 'Packaging machinery (DE)',
          palletisingLink: 'Palletising systems (DE)',
